...
exports.useGetCurrentUserAnnouncementOptOut = function useGetCurrentUserAnnouncementOptOut(dcOrOptions, options) {
  const { dc: dcInstance, options: inputOpts } = validateReactArgs(connectorConfig, dcOrOptions, options);
...
exports.useUpdateAnnouncementEmailsOptOut = function useUpdateAnnouncementEmailsOptOut(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {

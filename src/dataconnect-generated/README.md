...
You can execute the `GetTicketOrdersStripeArtifactsForCallable` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [dataconnect-generated/index.d.ts](./index.d.ts):
```typescript
getTicketOrdersStripeArtifactsForCallable(vars: GetTicketOrdersStripeArtifactsForCallableVariables): QueryPromise<GetTicketOrdersStripeArtifactsForCallableData, GetTicketOrdersStripeArtifactsForCallableVariables>;

interface GetTicketOrdersStripeArtifactsForCallableRef {
  ...
  /* Allow users to create refs without passing in DataConnect */
  (vars: GetTicketOrdersStripeArtifactsForCallableVariables): QueryRef<GetTicketOrdersStripeArtifactsForCallableData, GetTicketOrdersStripeArtifactsForCallableVariables>;
}
export const getTicketOrdersStripeArtifactsForCallableRef: GetTicketOrdersStripeArtifactsForCallableRef;
```
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getTicketOrdersStripeArtifactsForCallable(dc: DataConnect, vars: GetTicketOrdersStripeArtifactsForCallableVariables): QueryPromise<GetTicketOrdersStripeArtifactsForCallableData, GetTicketOrdersStripeArtifactsForCallableVariables>;

interface GetTicketOrdersStripeArtifactsForCallableRef {
  ...
  (dc: DataConnect, vars: GetTicketOrdersStripeArtifactsForCallableVariables): QueryRef<GetTicketOrdersStripeArtifactsForCallableData, GetTicketOrdersStripeArtifactsForCallableVariables>;
}
export const getTicketOrdersStripeArtifactsForCallableRef: GetTicketOrdersStripeArtifactsForCallableRef;
```

If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the getTicketOrdersStripeArtifactsForCallableRef:
```typescript
const name = getTicketOrdersStripeArtifactsForCallableRef.operationName;
console.log(name);
```
...
```
### Return Type
Recall that executing the `GetTicketOrdersStripeArtifactsForCallable` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `GetTicketOrdersStripeArtifactsForCallableData`, which is defined in [dataconnect-generated/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `GetTicketOrdersStripeArtifactsForCallable`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getTicketOrdersStripeArtifactsForCallable, GetTicketOrdersStripeArtifactsForCallableVariables } from '@dataconnect/generated';

// The `GetTicketOrdersStripeArtifactsForCallable` query requires an argument of type `GetTicketOrdersStripeArtifactsForCallableVariables`:
const getTicketOrdersStripeArtifactsForCallableVars: GetTicketOrdersStripeArtifactsForCallableVariables = {
  orderIds: ..., 
};

// Call the `getTicketOrdersStripeArtifactsForCallable()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await getTicketOrdersStripeArtifactsForCallable(getTicketOrdersStripeArtifactsForCallableVars);
// Variables can be defined inline as well.
const { data } = await getTicketOrdersStripeArtifactsForCallable({ orderIds: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await getTicketOrdersStripeArtifactsForCallable(dataConnect, getTicketOrdersStripeArtifactsForCallableVars);

console.log(data.ticketOrders);

// Or, you can use the `Promise` API.
getTicketOrdersStripeArtifactsForCallable(getTicketOrdersStripeArtifactsForCallableVars).then((response) => {
  const data = response.data;
  console.log(data.ticketOrders);
});
```

### Using `GetTicketOrdersStripeArtifactsForCallable`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getTicketOrdersStripeArtifactsForCallableRef, GetTicketOrdersStripeArtifactsForCallableVariables } from '@dataconnect/generated';
...
// Call the `getTicketOrdersStripeArtifactsForCallableRef()` function to get a reference to the query.
const ref = getTicketOrdersStripeArtifactsForCallableRef(getTicketOrdersStripeArtifactsForCallableVars);
// Variables can be defined inline as well.
const ref = getTicketOrdersStripeArtifactsForCallableRef({ orderIds: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = getTicketOrdersStripeArtifactsForCallableRef(dataConnect, getTicketOrdersStripeArtifactsForCallableVars);
...
```typescript
getMyTicketOrders(): QueryPromise<GetMyTicketOrdersData, undefined>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getMyTicketOrders(dc: DataConnect): QueryPromise<GetMyTicketOrdersData, undefined>;
...
```typescript
getMyBookingPaymentAdjustments(): QueryPromise<GetMyBookingPaymentAdjustmentsData, undefined>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getMyBookingPaymentAdjustments(dc: DataConnect): QueryPromise<GetMyBookingPaymentAdjustmentsData, undefined>;
...
```typescript
listBookingPaymentAdjustmentsForAdmin(vars: ListBookingPaymentAdjustmentsForAdminVariables): QueryPromise<ListBookingPaymentAdjustmentsForAdminData, ListBookingPaymentAdjustmentsForAdminVariables>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
listBookingPaymentAdjustmentsForAdmin(dc: DataConnect, vars: ListBookingPaymentAdjustmentsForAdminVariables): QueryPromise<ListBookingPaymentAdjustmentsForAdminData, ListBookingPaymentAdjustmentsForAdminVariables>;

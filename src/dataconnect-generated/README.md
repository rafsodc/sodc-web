...
// Variables can be defined inline as well.
const { data } = await revokeAccessGroupFromSection({ sectionId: ..., accessGroupId: ..., purpose: ..., });
...
// Variables can be defined inline as well.
const ref = revokeAccessGroupFromSectionRef({ sectionId: ..., accessGroupId: ..., purpose: ..., });

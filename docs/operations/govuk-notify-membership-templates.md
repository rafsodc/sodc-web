...
Use static template copy for RAF SODC identity, why-they-received-it, and account contact (`admin@sodc.net`) — see **Voice and structure** in [govuk-notify-template-copy.md](./govuk-notify-template-copy.md). Do not include admin-only notes in personalisation.

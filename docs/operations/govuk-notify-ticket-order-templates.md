...
| Key | Type | Semantics |
|-----|------|-----------|
| `firstName` | text | User first name, or `there` if missing/blank |
...
All other keys: `firstName`, `eventTitle`, `ticketTypeTitle`, `quantity`, `totalFormatted`, `currencyDisplay`, `orderId`, `myPaymentsUrl` — same meaning as template 1.

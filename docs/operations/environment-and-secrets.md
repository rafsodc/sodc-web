...
- Booking lifecycle emails (#190, #547): template keys `bookingConfirmation`, `bookingRevision`, `bookingPendingApproval`, `bookingPendingApprovalModerator`, `bookingApproved`, `bookingChangesRequested` — see [govuk-notify-booking-templates.md](./govuk-notify-booking-templates.md).

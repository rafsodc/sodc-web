...
function getTicketOrdersStripeArtifactsForCallable(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetTicketOrdersStripeArtifactsForCallable', inputVars, inputOpts);
}
exports.getTicketOrdersStripeArtifactsForCallable = getTicketOrdersStripeArtifactsForCallable;

...
function createMigratedUserProfileAndIdentity(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('CreateMigratedUserProfileAndIdentity', inputVars, inputOpts);
}
exports.createMigratedUserProfileAndIdentity = createMigratedUserProfileAndIdentity;

function linkLegacyIdentityToExistingUser(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('LinkLegacyIdentityToExistingUser', inputVars, inputOpts);
}
exports.linkLegacyIdentityToExistingUser = linkLegacyIdentityToExistingUser;

function getLegacyUserIdentity(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetLegacyUserIdentity', inputVars, inputOpts);
}
exports.getLegacyUserIdentity = getLegacyUserIdentity;

function listLegacyUserIdentitiesByBatch(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
...
function getBookingReplayForBookerEventKey(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetBookingReplayForBookerEventKey', inputVars, inputOpts);
}
exports.getBookingReplayForBookerEventKey = getBookingReplayForBookerEventKey;
...
function getSectionAnnouncementOptOutsPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetSectionAnnouncementOptOutsPaged', inputVars, inputOpts);
}
exports.getSectionAnnouncementOptOutsPaged = getSectionAnnouncementOptOutsPaged;
...
function getAnnouncementRecipientProgressPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementRecipientProgressPaged', inputVars, inputOpts);
}
exports.getAnnouncementRecipientProgressPaged = getAnnouncementRecipientProgressPaged;

function getAnnouncementRecipientProgressSummary(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementRecipientProgressSummary', inputVars, inputOpts);
}
exports.getAnnouncementRecipientProgressSummary = getAnnouncementRecipientProgressSummary;
...
function getAnnouncementRecipientsForResumePaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementRecipientsForResumePaged', inputVars, inputOpts);
}
exports.getAnnouncementRecipientsForResumePaged = getAnnouncementRecipientsForResumePaged;
...
function getAnnouncementSendRecipientsPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementSendRecipientsPaged', inputVars, inputOpts);
}
exports.getAnnouncementSendRecipientsPaged = getAnnouncementSendRecipientsPaged;

function getAnnouncementSendRecipientPage(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementSendRecipientPage', inputVars, inputOpts);
}
exports.getAnnouncementSendRecipientPage = getAnnouncementSendRecipientPage;

function getAnnouncementAudienceSection(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementAudienceSection', inputVars, inputOpts);
}
exports.getAnnouncementAudienceSection = getAnnouncementAudienceSection;

function getAnnouncementAudiencePurposeLinksPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementAudiencePurposeLinksPaged', inputVars, inputOpts);
}
exports.getAnnouncementAudiencePurposeLinksPaged = getAnnouncementAudiencePurposeLinksPaged;

function getAnnouncementExplicitMembersPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementExplicitMembersPaged', inputVars, inputOpts);
}
exports.getAnnouncementExplicitMembersPaged = getAnnouncementExplicitMembersPaged;

function getAnnouncementStatusMembersPaged(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetAnnouncementStatusMembersPaged', inputVars, inputOpts);
}
exports.getAnnouncementStatusMembersPaged = getAnnouncementStatusMembersPaged;
...
exports.tryUpdateAnnouncementRecipientDeliveryStatus = tryUpdateAnnouncementRecipientDeliveryStatus;
...
function getNotifyCallbackUserById(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetNotifyCallbackUserById', inputVars, inputOpts);
}
exports.getNotifyCallbackUserById = getNotifyCallbackUserById;

function tryApplyNotifyDeliveryUserState(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
...
exports.getNotifyDeliveryReceipt = getNotifyDeliveryReceipt;

function createNotifyDeliveryReceipt(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('CreateNotifyDeliveryReceipt', inputVars, inputOpts);
}
exports.createNotifyDeliveryReceipt = createNotifyDeliveryReceipt;

function claimNotifyDeliveryReceipt(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('ClaimNotifyDeliveryReceipt', inputVars, inputOpts);
}
exports.claimNotifyDeliveryReceipt = claimNotifyDeliveryReceipt;

function markNotifyDeliveryReceiptProcessed(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('MarkNotifyDeliveryReceiptProcessed', inputVars, inputOpts);
}
exports.markNotifyDeliveryReceiptProcessed = markNotifyDeliveryReceiptProcessed;

function markNotifyDeliveryReceiptFailed(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeMutation('MarkNotifyDeliveryReceiptFailed', inputVars, inputOpts);
}
exports.markNotifyDeliveryReceiptFailed = markNotifyDeliveryReceiptFailed;

function getRecentNotifyDeliveryReceiptsForUser(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetRecentNotifyDeliveryReceiptsForUser', inputVars, inputOpts);
}
exports.getRecentNotifyDeliveryReceiptsForUser = getRecentNotifyDeliveryReceiptsForUser;

function getLatestNotifyDeliveryReceiptForReference(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);
  return dcInstance.executeQuery('GetLatestNotifyDeliveryReceiptForReference', inputVars, inputOpts);
}
exports.getLatestNotifyDeliveryReceiptForReference = getLatestNotifyDeliveryReceiptForReference;
...
function updateAnnouncementOptOutAll(dcOrVarsOrOptions, varsOrOptions, options) {
  const { dc: dcInstance, vars: inputVars, options: inputOpts} = validateAdminArgs(connectorConfig, dcOrVarsOrOptions, varsOrOptions, options, true, true);
  dcInstance.useGen(true);

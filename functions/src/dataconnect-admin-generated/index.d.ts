...
/** Generated Node Admin SDK operation action function for the 'GetTicketOrdersStripeArtifactsForCallable' Query. Allow users to execute without passing in DataConnect. */
export function getTicketOrdersStripeArtifactsForCallable(dc: DataConnect, vars: GetTicketOrdersStripeArtifactsForCallableVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetTicketOrdersStripeArtifactsForCallableData>>;
/** Generated Node Admin SDK operation action function for the 'GetTicketOrdersStripeArtifactsForCallable' Query. Allow users to pass in custom DataConnect instances. */
export function getTicketOrdersStripeArtifactsForCallable(vars: GetTicketOrdersStripeArtifactsForCallableVariables, options?: OperationOptions): Promise<ExecuteOperationResponse<GetTicketOrdersStripeArtifactsForCallableData>>;
